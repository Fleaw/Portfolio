...
function o(e){
var t="unhandledrejection"==e.type&&"object"==typeof e.reason?e.reason:"object"==typeof e.error?e.error:null,n=t?t.toString():"string"==typeof e.message?e.message:"string"==typeof e.reason?e.reason:"";
...
var o=e instanceof ErrorEvent?e.filename:t&&"string"==typeof t.fileName?t.fileName:t&&"string"==typeof t.sourceURL?t.sourceURL:"",s=e instanceof ErrorEvent?e.lineno:t&&"number"==typeof t.lineNumber?t.lineNumber:t&&"number"==typeof t.line?t.line:0;
r(n,o,s)}
}
function s(e,t){
if("symbolsUrl"!=e){
...
companyName:u.companyName,productName:u.productName,cacheControl:u.cacheControl(u[e])}
):new XMLHttpRequest;
...
n+=i;
for(var c=0,l=d.indexOf("/",c)+1;
l>0;
c=l,l=d.indexOf("/",c)+1)u.FS_createPath(d.substring(0,c),d.substring(c,l-1),!0,!0);
...
;
var u={
canvas:e,webglContextAttributes:{
preserveDrawingBuffer:!1}
,cacheControl:function(e){
return e==u.dataUrl?"must-revalidate":"no-store"}
,streamingAssetsUrl:"StreamingAssets",downloadProgress:{
}
,deinitializers:[],intervals:{
}
...
var e,t,n,r="-",o=navigator.appVersion,s=navigator.userAgent,a=navigator.appName,i=navigator.appVersion,d=parseInt(navigator.appVersion,10);
...
var u=/Mobile|mini|Fennec|Android|iP(ad|od|hone)/.test(o),c=r,l=[{
...
case"Mac OS X":h=/Mac OS X (10[\.\_\d]+)/.exec(s)[1];
break;
case"Android":h=/Android ([\.\_\d]+)/.exec(s)[1];
break;
case"iOS":h=/OS (\d+)_(\d+)_?(\d+)?/.exec(o),h=h[1]+"."+h[2]+"."+(0|h[3])}
return{
width:screen.width?screen.width:0,height:screen.height?screen.height:0,browser:a,browserVersion:i,mobile:u,os:c,osVersion:h,gpu:function(){
...
function r(){
function t(t){
if("undefined"==typeof r.database)for(r.database=t,r.database||e("indexedDB database could not be opened");
r.queue.length;
){
var n=r.queue.shift();
...
r.queue=[];
try{
var o=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB,s=o.open(a.name);
...
var s={
url:e,version:i.version,company:t,product:n,updated:r,revalidated:r,accessed:r,responseHeaders:{
}
,xhr:{
}
}
...
.bind(this))}
var a={
name:"UnityCache",version:2}
,i={
name:"XMLHttpRequest",version:1}
,d={
name:"WebAssembly",version:1}
;
...
var r=this.xhr,o=this.cache,s=arguments;
